...
echo "Test with four elements"
RES=$(./push_swap 1 2 3 4 | wc -l)
if ((RES != 0)); then
	printf "1 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 0\n\n"
else
	printf "1 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
...
RES=$(./push_swap 1 2 4 3 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "2 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "2 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 1 3 2 4 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "3 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "3 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 1 3 4 2 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "4 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "4 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 1 4 2 3 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "5 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "5 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 1 4 3 2 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "6 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "6 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 2 1 3 4 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "7 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "7 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 2 1 4 3 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "8 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "8 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 2 3 1 4 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "9 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "9 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 2 3 4 1 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "10 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "10 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 2 4 1 3 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "11 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "11 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 2 4 3 1 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "12 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "12 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 3 1 2 4 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "13 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "13 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 3 1 4 2 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "14 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "14 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 3 2 1 4 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "15 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "15 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 3 2 4 1 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "16 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "16 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 3 4 1 2 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "17 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "17 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 3 4 2 1 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "18 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "18 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 4 1 2 3 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "19 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "19 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 4 1 3 2 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "20 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "20 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 4 2 1 3 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "21 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "21 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 4 2 3 1 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "22 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "22 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 4 3 1 2 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "23 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "23 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi

RES=$(./push_swap 4 3 2 1 | wc -l)
((MAX_SUCCESS_COUNT++))
if ((RES > 6)); then
	printf "24 test$RED_COLOR failed$RESET_COLOR\nReturned count: $RES\nExpected count: 6\n\n"
else
	printf "24 test$GREEN_COLOR succeed$RESET_COLOR\n\n"
	((SUCCESS_COUNT++))
fi
